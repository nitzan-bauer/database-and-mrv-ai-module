  ...
  record_vvb_finding: {
    schema: {
      ...
      inputSchema: {
        ...
        properties: {
          ...
          samplingCycleId: { type: "string", description: "The sampling cycle this finding concerns, if known — lets it be traced back to root cause instead of only free text." },
          modelRunId: { type: "string", description: "The model run this finding concerns, if known." },
          baselineSiteId: { type: "string", description: "The baseline (BSL) site this finding concerns, if known." },
          workOrderId: { type: "string", description: "The work order this finding concerns, if known." },
        },
    ...
    handler: (ctx, input) =>
      recordVvbFinding(ctx, {
        ...
        samplingCycleId: input.samplingCycleId as string | undefined,
        modelRunId: input.modelRunId as string | undefined,
        baselineSiteId: input.baselineSiteId as string | undefined,
        workOrderId: input.workOrderId as string | undefined,
      }),
  },
